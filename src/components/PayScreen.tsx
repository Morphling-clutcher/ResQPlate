...
import { ArrowLeft, Leaf, ShoppingBag, Landmark, Lock, HelpCircle, AlertCircle, Sparkles, ReceiptText } from 'lucide-react';
...
export default function PayScreen({ 
  ...
  return (
    <div className="min-h-screen bg-brand-bg flex flex-col max-w-md mx-auto" id="pay-screen-container">
      {/* Navigation Header */}
      <div className="bg-white border-b border-brand-outline px-4 py-4 flex items-center justify-between sticky top-0 z-20" id="pay-header">
        <button
          onClick={onBack}
      ...
      {/* Main Container */}
      <div className="p-4 space-y-6 flex-1 overflow-y-auto" id="pay-scrollable-content">
        
        {/* Section: Review Order */}
        <div className="space-y-3" id="review-order-section">
          <h2 className="text-xl font-extrabold text-brand-text tracking-tight" id="review-order-heading">
            Review Order
          </h2>
          ...
          <div className="bg-white p-5 rounded-2xl border border-brand-outline shadow-level-2 space-y-4" id="review-card-main">
            <div className="flex items-start gap-4" id="review-card-body">
              {/* Box/Cabinet-style Mock Icon block */}
              ...
              <div className="flex-1 min-w-0" id="review-card-meta">
                <h3 className="text-lg font-bold text-brand-text truncate leading-tight" id="review-item-title">
                  {bag.name}
                </h3>
                <p className="text-xs text-brand-text-muted mt-1 font-medium" id="review-item-store">
              ...
              <div className="text-right shrink-0" id="review-card-pricing">
                <p className="text-lg font-extrabold text-brand-primary font-mono" id="review-price">
            ...
            <div className="bg-[#eafaf1] border border-[#a7f3d0]/30 px-4 py-3 rounded-xl flex items-center gap-3" id="review-impact-subcard">
              ...
              <p className="text-xs text-slate-700 leading-normal" id="review-impact-text">
        ...
        <div className="space-y-3.5" id="payment-method-section">
          <h2 className="text-xl font-extrabold text-brand-text tracking-tight" id="payment-method-heading">
            Payment Method
          </h2>
        ...
        <div className="text-center px-4 pt-2" id="pay-footer-disclaimer-card">
